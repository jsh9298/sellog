...
const sizes = [
    { width: 100, height: 100, folder: "100x100" },      // 피드용 썸네일 (프로필 리스트 등)
    { width: 400, height: 400, folder: "400x400" },      // 상품 카드 썸네일 (카탈로그용)
    { width: 800, height: 450, folder: "800x450" },      // 미디어 피드 (스토리/게시글 미리보기)
    { width: 600, height: 600, folder: "600x600" },      // 상세페이지 미리보기
    { width: 1200, height: 675, folder: "1200x675" },    // 배너/슬라이드용
];
