...
public class UserInfoController {
        ...
        public ResponseEntity<?> userProfile(@PathVariable String userId,
                ...
                UserProfileResponse response = userInfoService.findUserProfile(userId, selfId, type, lastCreateAt,
                                lastId,
                                limit);
        ...
        public ResponseEntity<?> userProfileEdit(@RequestBody UserProfileRequest userProfileRequest,
                ...
                UserProfileResponse response = userInfoService.findUserProfile(selfId, selfId, "POST", null, null,
                                limit);
                return ResponseEntity
        ...
        public ResponseEntity<?> userProfilePreview(@PathVariable String userId,
                ...
                UserPreviewResponse response = userInfoService.findUserPreview(userId, type, lastCreateAt, lastId,
                                limit);
                return ResponseEntity
